...
2 ลงทะเบียนใช้งาน API กับ สพร.



โดย สพร จะส่ง Consumer-Key และข้อมูลสำหรับทดสอบการเรียก API ให้หน่วยงาน
...
3 ทดสอบและพัฒนาระบบ โดยเรียก API
   ...
   3.2 API สร้าง BillPayment

   3.3 API ตรวจสอบถานะการรับชำระเงิน
